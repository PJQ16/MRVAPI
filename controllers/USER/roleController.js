...
const {RoleModel} =  require('../../models/associate')
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await RoleModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await RoleModel.findAll();
...
exports.modify = async (req, res) => {
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await RoleModel.destroy({
        where: {
          id: id
        }
      });
