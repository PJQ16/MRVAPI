...
const {UserPlanModel} = require('../../models/associate');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await UserPlanModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await UserPlanModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await UserPlanModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await UserPlanModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await UserPlanModel.destroy({
        where: {
          id: id
        }
      });
