...
const {MileStoneModel} =  require('../../models/associate')
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await MileStoneModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await MileStoneModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await MileStoneModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await MileStoneModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await MileStoneModel.destroy({
        where: {
          id: id
        }
      });
