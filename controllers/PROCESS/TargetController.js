...
const {TargetModel} =  require('../../models/associate');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await TargetModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await TargetModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await TargetModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await TargetModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await TargetModel.destroy({
        where: {
          id: id
        }
      });
