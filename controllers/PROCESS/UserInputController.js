...
const {UserInputModel} = require('../../models/associate');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await UserInputModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await UserInputModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await UserInputModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await UserInputModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await UserInputModel.destroy({
        where: {
          id: id
        }
      });
