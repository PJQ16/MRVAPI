...
const {Multi_factorModel} =  require('../../models/associate');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await Multi_factorModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await Multi_factorModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await Multi_factorModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await Multi_factorModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await Multi_factorModel.destroy({
        where: {
          id: id
        }
      });
