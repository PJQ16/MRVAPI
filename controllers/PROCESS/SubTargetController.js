...
const {SubTargetModel} =  require('../../models/associate');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await SubTargetModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await SubTargetModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await SubTargetModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await SubTargetModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await SubTargetModel.destroy({
        where: {
          id: id
        }
      });
