...
const {StaticAssumptionModel} =  require('../../models/associate');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await StaticAssumptionModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await StaticAssumptionModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await StaticAssumptionModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await StaticAssumptionModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await StaticAssumptionModel.destroy({
        where: {
          id: id
        }
      });
