...
const {VerifyModel} =  require('../../models/associate');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await VerifyModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await VerifyModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await VerifyModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await VerifyModel.update(updateData, {
        where: {
          id: id
        }
      });
  ...
  exports.remove = async (req, res) => {
    try {
      ...
      const affectedRows = await VerifyModel.destroy({
        where: {
          id: id
        }
      });
