...
const PlanModel =  require('../../models/PROCESS/PlanModel');
exports.read = async(req,res)=>{
    try{
        ...
        const ShowData = await PlanModel.findByPk(id);
...
exports.list = async(req,res)=>{
    try{
       const ShowDataList = await PlanModel.findAll();
...
exports.create = async(req,res)=>{
    try{
       const addData = await PlanModel.create(req.body);
...
exports.modify = async (req, res) => {
    try {
      ...
      const [affectedRows] = await PlanModel.update(updateData, {
        where: {
          id: id
        }
      });
